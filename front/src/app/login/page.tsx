...
export default function Login() {
  ...
  async function verificaLogin(data: Inputs) {
    try {
      ...
      if (!response.ok) {
        const errorData = await response.text(); // Logar o conteúdo bruto para depuração
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="manter" className="text-gray-500 dark:text-gray-300">
                      Manter Conectado
                    </label>
                  </div>
                </div>
